"! @testing BDEF:ZR_RAP100_TRAV
CLASS zrap100_tc_travel_eml_il DEFINITION
  PUBLIC
  FINAL
...
CLASS zrap100_tc_travel_eml_il IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZR_RAP100_TRAV' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zr_rap100_trav
     ENTITY ZrRap100Trav
    ...
    cl_abap_unit_assert=>assert_not_initial( msg = 'mapped-travel'  act = mapped-zrrap100trav ).
    ...
    SELECT * FROM zr_rap100_trav INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
