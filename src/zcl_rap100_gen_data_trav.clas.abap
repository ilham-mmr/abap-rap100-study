CLASS zcl_rap100_gen_data_trav DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_trav IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_trav.
    DELETE FROM zrap100_trav_d.

    "insert travel demo data
    INSERT zrap100_trav  FROM (
        SELECT
